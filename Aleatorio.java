...
public class Aleatorio {
    ...
    public static SortResult bucketSortRandom(int[] array) {
        long swaps = 0;
        long comparisons = 0;
        long startTime = System.currentTimeMillis();
        ...
        for (java.util.List<Integer> bucket : buckets) {
            if (!bucket.isEmpty()) {
                ...
                SortResult bucketResult = insertionSortRandom(bucketArray);
    ...
    public static void main(String[] args) {
        ...
        for (int size : sizes) {
            ...
            arrayCopy = array.clone();
            SortResult bucketSortResult = bucketSortRandom(arrayCopy);
            System.out.println("Bucket Sort Random - Trocas: " + bucketSortResult.swaps + ", Comparacoes: " + bucketSortResult.comparisons + ", Tempo: " + bucketSortResult.time + " ms (" + bucketSortResult.getTimeInSeconds() + " s)");
